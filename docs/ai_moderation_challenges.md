...
## 六、 模型微调的难点 (Fine-tuning Challenges)
...
### 2. 安全对齐的冲突
* 主流大模型（GPT-4、Gemini、Claude）都经过了严格的安全对齐（RLHF / Constitutional AI）。当你试图让模型"理解"并"分析"违规内容时，它的安全层会主动拒绝处理这些内容——**模型会拒绝看你让它审核的东西**。
...
## 七、 训练工程层面的难点 (Training Engineering Challenges)
